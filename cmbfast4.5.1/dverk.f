...
c
  ...
  505 format( /// 'computation stopped in dverk with the following',
     +   'values -'
     +   / 'ind =', i4, 5x, 'tol  =', 1pd13.6, 5x, 'x         =',
     +          1pd22.15
     +   / 'n   =', i4, 5x, 'hmin =', 1pd13.6, 5x, 'xend      =',
     +          1pd22.15
     +   / 'nw  =', i4, 5x, 'hmax =', 1pd13.6, 5x, 'prev xend =',
     +          1pd22.15
     +   / 14x, 'no of successful steps    =', 0pf8.0
     +   / 14x, 'no of successive failures =', 0pf8.0
     +   / 14x, 'no of function evals      =', 0pf8.0
